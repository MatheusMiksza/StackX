...
-- seleciona todos os nomes que terminam com a letra epecificada
-- select nome from empregado
-- where nome like '%s'

-- seleciona os dados que começem com o valor especificado
-- select nome,cpf idade from empregado
-- where cpf not like '9999%'

-- seleciona o nome que tem a segunda e a ultima letra do valor especificado
-- select nome, especialidade from medicos
-- where nome like '_o%' '%o'

-- select nome, ano_admissao from funcionarios
-- where ano_admissao between 1999 and 2009 order by ano_admissao
